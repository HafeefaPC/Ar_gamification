...
class AppTheme {
  ...
  static BoxDecoration NFTContainerDecoration = BoxDecoration(
    color: const Color.fromARGB(255, 122, 185, 203), // Light yellow color
    borderRadius: BorderRadius.circular(16),
    border: Border.all(color: textColor, width: 2), // Light blue border
