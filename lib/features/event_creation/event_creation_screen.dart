  ...
  Future<void> _createEvent() async {
    ...
    if (currentChainId != '50312') {
      ...
      if (!switched) {
        ...
        _showRetroError(
          'Please manually switch to Somnia Testnet network in your wallet settings.',
        );
        return;
      }
      ...
      if (finalChainId != '50312') {
        ...
        _showRetroError(
          'Chain switch failed. Please manually switch to Somnia Testnet in your wallet settings.',
        );
        return;
      }
      ...
      print(
        '✅ Already on Somnia Testnet (Chain ID: ${updatedWalletState.chainId} -> $currentChainId)',
      );
    }
